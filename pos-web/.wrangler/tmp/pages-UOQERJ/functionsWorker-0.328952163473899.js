...
var onRequestGet2 = /* @__PURE__ */ __name(async (context) => {
  ...
  if (data) {
    ...
    return new Response(data, { headers: corsHeaders3 });
  } else {
...
var onRequest = /* @__PURE__ */ __name(async (context) => {
  ...
  const response = await fetch(targetUrl, {
    ...
    headers,
    body: context.request.method !== "GET" && context.request.method !== "HEAD" ? context.request.body : void 0
  });
...
// ../.wrangler/tmp/pages-UOQERJ/functionsRoutes-0.8137090806591452.mjs
var routes = [
  {
